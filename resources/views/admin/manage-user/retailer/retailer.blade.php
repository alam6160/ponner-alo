    ...
    <div class="col-lg-12">
        <div class="content-wrap">
            <div class="form-wrap">
                ...
                <form action="" method="POST" id="retailer_form">
                    <div class="row">
                        <div class="col-lg-4">
                            @php
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <input class="form-control" type="text" name="organization_name" id="organization_name" value="{{ empty($user) ? '' : $user->retailer_prfile->organization_name }}">
                            </fieldset>
                        </div>
                        <div class="col-lg-6">
                            <fieldset>
                                <label for="licence">Licence</label>
                                <input class="form-control" type="text" name="licence" id="licence" value="{{ empty($user) ? '' : $user->retailer_prfile->licence }}">
                            </fieldset>
                        </div>
                        ...
                        {{-- <div class="col-lg-6">
                            <fieldset>
                                ...
                                <textarea class="form-control" cols="" rows="4" placeholder="Enter Servicable Pincodes" name="servicable_pincodes" id="servicable_pincodes" required>{{ empty($user) ? '' : $user->retailer_prfile->servicable_pincodes }}</textarea>
                            </fieldset>
                        </div> --}}

                        @php
                            $agent_id = (empty($user)) ? '' : $user->retailer_prfile->agent_id;
                        @endphp
                        <div class="col-lg-6">
                            <fieldset class="select-box">
                        ...
                        @php
                            $servicable_pincodes = (empty($user)) ? [] : array_filter(explode(',',$user->retailer_prfile->servicable_pincodes));
                        @endphp
                        <div class="col-lg-6">
                            <fieldset class="select-box">
                        ...
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                <textarea class="form-control" cols="" rows="1" placeholder="Enter Address" name="address" id="address">{{ empty($user) ? '' : $user->retailer_prfile->address }}</textarea>
                            </fieldset>
                        </div>

                        @php
                            $state_id = (empty($user)) ? '' : $user->retailer_prfile->state_id;
                        @endphp
                        <div class="col-lg-6">
                            <fieldset class="select-box">
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <input class="form-control" type="tel" name="pin_code" id="pin_code" value="{{ empty($user) ? '' : $user->retailer_prfile->pin_code }}" onkeypress="return onlyNumberKey(event)" data-parsley-type="integer">
                            </fieldset>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#retailer_form').submit(function (e) { 
                e.preventDefault();
                if ($('#retailer_form').parsley().isValid()) {
                    const formID = 'retailer_form';
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.manage-user.retailer.create') }}",
            ...
            $('#retailer_form').submit(function (e) { 
                ...
                if ($('#retailer_form').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.manage-user.retailer.edit', ['id'=>$user->id]) }}",
                        data: new FormData(this),
                        cache: false,
                        processData: false,
                        contentType: false,

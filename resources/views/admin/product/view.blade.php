                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <fieldset>
                                        ...
                                        <input id="name" class="form-control cfcrl" type="text" name="name" readonly value="{{ $product->name }}">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6">
                                    <fieldset>
                                ...
                                <div class="col-lg-6">
                                    <fieldset class="select-box">
                                        ...
                                        <select disabled class="form-control select2" id="category_id" name="category_ids[]" multiple required data-parsley-errors-container="#category_id_error">
                                ...
                                <div class="col-lg-6">
                                    <fieldset class="select-box">
                                        ...
                                        <select disabled class="form-control" id="product_filter_id" name="saletype">
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                        ...
                                        <textarea readonly name="short_desc" id="short_desc" class="form-control cfcrl" rows="2">{{ $product->short_desc }}</textarea>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <label for="">Product Descriptions</label>
                                        <textarea disabled name="description" id="description" class="form-control cfcrl" rows="2">{{ htmlspecialchars_decode($product->description) }}</textarea>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <fieldset>
                                        ...
                                        <input readonly id="number_of_items" class="form-control cfcrl" type="number" name="number_of_items" value="{{ $product->number_of_items }}" onkeypress="return onlyNumberKey(event)">
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <fieldset class="select-box">
                                        ...
                                        <select disabled class="form-control cfcrl" id="product_type" name="product_type" required onchange="setVariableDiv()">
                                ...
                                <div class="row" id="variableDiv">
                                    <div class="col-lg-5">
                                        <fieldset>
                                            ...
                                            <input readonly id="attribute_1" class="form-control cfcrl" type="text" name="attribute_1" onkeyup="setVarientTitle(this)" value="{{ $product->attribute_1 }}">
                                        </fieldset>
                                    </div>
                                    @php
                                    ...
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            ...
                                            <select disabled class="form-control" id="specifications_1" name="specifications_1[]" multiple onchange="setPriceHtml()">
                                    ...
                                    <div class="col-lg-5">
                                        <fieldset>
                                            ...
                                            <input disabled id="attribute_2" class="form-control cfcrl" type="text" name="attribute_2" onkeyup="setVarientTitle(this)" value="{{ $product->attribute_2 }}">
                                        </fieldset>
                                    </div>
                                    @php
                                    ...
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            ...
                                            <select disabled class="form-control" id="specifications_2" name="specifications_2[]" multiple onchange="setPriceHtml()">
                                    ...
                                    <div class="col-lg-5">
                                        <fieldset>
                                            ...
                                            <input readonly id="attribute_3" class="form-control cfcrl" type="text" name="attribute_3" onkeyup="setVarientTitle(this)" value="{{ $product->attribute_3 }}">
                                        </fieldset>
                                    </div>
                                    @php
                                    ...
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            ...
                                            <select disabled class="form-control" id="specifications_3" name="specifications_3[]" multiple onchange="setPriceHtml()">
                            ...
                            @elseif ($product->product_type == '1')
                                <div class="row" id="variableDiv" style="display: none;">
                                    <div class="col-lg-5">
                                        <fieldset>
                                            <label for="attribute_1">Attribute 1 <strong id="attribute_1_label" class="text-danger"></strong></label>
                                            <input readonly id="attribute_1" class="form-control cfcrl" type="text" name="attribute_1" onkeyup="setVarientTitle(this)">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            <label id="attribute_1_title">Attribute Title</label>
                                            <select disabled class="form-control" id="specifications_1" name="specifications_1[]" multiple onchange="setPriceHtml()"></select>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-5">
                                        <fieldset>
                                            <label for="attribute_2">Attribute 2 <strong id="attribute_2_label" class="text-danger"></strong></label>
                                            <input readonly id="attribute_2" class="form-control cfcrl" type="text" name="attribute_2" onkeyup="setVarientTitle(this)">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            <label id="attribute_2_title">Attribute Title</label>
                                            <select disabled class="form-control" id="specifications_2" name="specifications_2[]" multiple onchange="setPriceHtml()"></select>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-5">
                                        <fieldset>
                                            <label for="attribute_3">Attribute 3 <strong id="attribute_3_label" class="text-danger"></strong></label>
                                            <input readonly id="attribute_3" class="form-control cfcrl" type="text" name="attribute_3" onkeyup="setVarientTitle(this)">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-7">
                                        <fieldset class="select-box">
                                            <label id="attribute_3_title">Attribute Title</label>
                                            <select disabled class="form-control" id="specifications_3" name="specifications_3[]" multiple onchange="setPriceHtml()"></select>
                                        </fieldset>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="tab-pane fade " id="pricingTab" role="tabpanel" aria-labelledby="pricing-tab">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input readonly id="sku_code" class="form-control cfcrl" type="text" name="sku_code[]" autocomplete="off" value="{{ $product->sku }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="mrp" class="col-sm-3 col-form-label">MRP <strong class="text-danger">*</strong></label>
                                <div class="col-sm-5">
                                    <input readonly type="tel" id="mrp" class="form-control cfcrl" name="mrp[]" required data-parsley-type="digits" onclick="firstDeci()" onkeypress="return isNumberKey(this, event);" autocomplete="off" value="{{ $product->mrp }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="discounted_price" class="col-sm-3 col-form-label">Discounted Ammount </label>
                                <div class="col-sm-5">
                                    <input readonly type="tel" id="discounted_price" class="form-control cfcrl" name="discounted_price[]" data-parsley-type="digits" onclick="firstDeci()" onkeypress="return isNumberKey(this, event);" autocomplete="off" value="{{ $product->discounted_price }}">
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <fieldset>
                                            ...
                                            <input readonly id="varient_set" class="form-control cfcrl" type="tel" name="varient_set[]" required value="{{ (!empty($specification)) ? $specification : '' }}" readonly>
                                    ...
                                    <div class="col-lg-3">
                                        <fieldset>
                                            ...
                                            <input readonly id="mrp" class="form-control cfcrl" type="tel" name="mrp[]" required data-parsley-type="digits" onclick="firstDeci()" onkeypress="return isNumberKey(this, event);" autocomplete="off" value="{{ (!empty($mrps[$key])) ? $mrps[$key] : '0' }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-3">
                                        <fieldset>
                                            <label for="mrp">SKU Code </label>
                                            <input readonly id="sku_code" class="form-control cfcrl" type="text" name="sku_code[]" autocomplete="off" value="{{ (!empty($skus[$key])) ? $skus[$key] : '' }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-3">
                                        <fieldset>
                                            <label for="discounted_price">Discounted Ammount </label>
                                            <input readonly id="discounted_price" class="form-control cfcrl" type="tel" name="discounted_price[]" data-parsley-type="digits" onclick="firstDeci()" onkeypress="return isNumberKey(this, event);" autocomplete="off" value="{{ (!empty($discounted_prices[$key])) ? $discounted_prices[$key] : '' }}">
                                        </fieldset>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        <div class="tab-pane fade" id="pimagesTab" role="tabpanel" aria-labelledby="pimages-tab">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input disabled type="file" name="featured_image" class="custom-file-input form-control" id="featured_image" accept=".png,.jpeg,.png">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input disabled type="file" name="images[]" multiple class="custom-file-input form-control" id="images" accept=".png,.jpeg,.png,.webp">
                        ...
                        <div class="tab-pane fade" id="seoTab" role="tabpanel" aria-labelledby="seo-tab">
                            <div class="col-lg-12">
                                <fieldset>
                                    ...
                                    <input readonly id="metakeywords" class="form-control cfcrl" type="text" name="metakeywords" value="{{ $product->metakeywords }}">
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                                    <label for="metadescriptions">Meta Descriptions</label>
                                    <textarea disabled name="metadescriptions" id="metadescriptions" class="form-control cfcrl" rows="4">{{ $product->metadescriptions }}</textarea>
                                </fieldset>
                            </div>
                        </div>
                    </div>

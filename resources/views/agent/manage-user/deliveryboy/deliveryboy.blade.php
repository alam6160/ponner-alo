                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                <textarea class="form-control" cols="" rows="1" placeholder="Enter Address" name="address" id="address">{{ empty($user) ? '' : $user->deliveryboy_profile->address }}</textarea>
                            </fieldset>
                        </div>
        ...
        $(function(){
            ...
            $('#deliveryboy_form').submit(function (e) { 
                ...
                if ($('#deliveryboy_form').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('agent.manage-user.deliveryboy.create') }}",
            ...
            $('#deliveryboy_form').submit(function (e) { 
                ...
                if ($('#deliveryboy_form').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('agent.manage-user.deliveryboy.edit', ['id'=>$user->id]) }}",
                        data: new FormData(this),
                        cache: false,
                        processData: false,
                        contentType: false,

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <textarea class="form-control" cols="" rows="4" placeholder="Enter Address" name="address" id="address">{{ empty($user) ? '' : $user->retailer_prfile->address }}</textarea>
                            </fieldset>
                        </div>
        ...
        $(function(){
            ...
            $('#retailer_form').submit(function (e) { 
                ...
                if ($('#retailer_form').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('agent.manage-user.retailer.create') }}",
            ...
            $('#retailer_form').submit(function (e) { 
                ...
                if ($('#retailer_form').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('agent.manage-user.retailer.edit', ['id'=>$user->id]) }}",
                        data: new FormData(this),
                        cache: false,
                        processData: false,
                        contentType: false,

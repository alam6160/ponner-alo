...
<head>
    ...
    <title>{{ Helper::csname() }} | @yield('title')</title>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid"> 
                <a class="navbar-brand" href="{{ route('agent.dashboard') }}">
                    <img src="{{ Helper::adminLogo() }}" alt="logo">
                </a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown user"> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> 
                            ...
                            <a class="dropdown-item" href="{{ route('agent.profile.chagepassword') }}">
    ...
    <footer>
        <div class="footer-inner">
            ...
            <div class="right-info">
                <span>&copy; {{ Helper::csname() }}. All Right Resercved | {{ date('Y') }}</span>
            </div>
        </div>
    </footer>

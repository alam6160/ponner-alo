...
class ManageRetailerController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = \App\Models\User::select($select)->join('retailer_profiles','users.id','=','retailer_profiles.retailer_id')->where('users.user_type', $user_type)->where('retailer_profiles.statehead_id', auth()->user()->id)->get();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('actions', function($data) {
                    ...
                    if ($data->trashed()) {
                        ...
                        $btn = '<a href="'.route('statehead.manage-user.retailer.edit', ['id'=>$data->id]).'" class="btn-ancher"><i class="fa fa-pencil-square-o fa-lg"></i></a>';
        ...
        return view('statehead.manage-user.retailer.index', $data);
    }
    public function create(Request $request)
    {
        ...
        $data['allstates'] = \App\Models\State::all();
        return view('statehead.manage-user.retailer.retailer', $data);
    }
    public function edit(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            if (blank($user)) {
                return ['type'=>'redirect', 'url'=> route('statehead.manage-user.retailer.index'),'message'=>'This Retailer is already deleted' ];
            }
        ...
        if (blank($user)) {
            return redirect()->route('statehead.manage-user.retailer.index');
        }

...
class ProductAddonController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = \App\Models\ProductAddon::withTrashed()->get();
            return DataTables::of($data)
                ...
                ->addColumn('actions', function($data) {
                    ...
                    if ($data->trashed()) {
                        ...
                        $btn = '<a href="'.route('admin.product.addon.edit', ['id'=>$data->id]).'" class="btn-ancher"><i class="fa fa-pencil-square-o fa-lg"></i></a>';
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.product.addon.index', $data);
    }
    public function edit(Request $request, $id)
    {
        $productAddon = \App\Models\ProductAddon::find($id);

        if ($request->ajax()) {

            if (blank($productAddon)) {
                return ['type'=>'redirect', 'url'=> route('admin.product.addon.create'),'message'=>'This product addon is already deleted' ];
            }
        ...
        if (blank($productAddon)) {
            return redirect()->route('admin.product.addon.create');
        }

...
class ManageDeliveryBoyController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = \App\Models\User::select($select)->join('deliveryboy_profiles','deliveryboy_profiles.deliveryboy_id', '=','users.id')->where('users.user_type', $user_type)->withTrashed()->get();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('actions', function($data) {
                    ...
                    if ($data->trashed()) {
                        ...
                        $btn = '<a href="'.route('admin.manage-user.deliveryboy.edit', ['id'=>$data->id]).'" class="btn-ancher"><i class="fa fa-pencil-square-o fa-lg"></i></a>';
        ...
        return view('admin.manage-user.deliveryboy.index', $data);
    }
    public function create(Request $request)
    {
        ...
        return view('admin.manage-user.deliveryboy.deliveryboy', $data);
    }
    public function edit(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            if (blank($user)) {
                return ['type'=>'redirect', 'url'=> route('admin.manage-user.deliveryboy.index'),'message'=>'This delivery boy is already delected' ];
            }
            ...
            if ($validator->fails()) {
                ...
                if ($user->save()) {
                    ...
                    $user->deliveryboy_profile->statehead_id = NULL;
                    if (!empty($request->agent_id)) {
                        $agentProfile = \App\Models\AgentProfile::select(['statehead_id'])->whereAgentId($request->agent_id)->first();
                        $user->deliveryboy_profile->statehead_id = (empty($agentProfile->statehead_id)) ? NULL : $agentProfile->statehead_id ;
                    }
        ...
        if (blank($user)) {
            return redirect()->route('admin.manage-user.deliveryboy.index');
        }
